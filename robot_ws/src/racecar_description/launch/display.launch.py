...
#这里使用动态创建的方式进行世界的创建，避免组员在本地模型文件路径不相同而导致世界加载失败
    ...
    return LaunchDescription([
        # 启动 Gazebo 仿真，加载定制世界文件，并设置为自启动模式
        ...
        Node(
            ...
            parameters=[{
                ...
                'frame_prefix': 'racecar/',#加上前缀，避免多车时TF冲突
        ...
        # 主桥接（带frame_prefix，不含 /scan/points）
